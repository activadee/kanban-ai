...
import {getAgentProfile as getProjectAgentProfile} from './profiles'
import {getGlobalAgentProfile} from './profiles-global'
...
export async function resolveAgentProfile<P>(
    ...
    try {
        ...
        return {
            profile: null,
            warning: `[profiles] failed to parse profile ${profileId}: ${
