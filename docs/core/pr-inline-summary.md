...
Projects can override the default PR summary prompt with a custom one via the **Custom Prompts** section in project settings. When a custom prompt is configured:
...
This allows you to tailor the PR summary behavior to your project's conventions while keeping the change context intact.
