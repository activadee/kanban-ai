...
See [Advanced features](core/advanced-features) for a deeper look at:

- Task dependencies and blocked-move rules.
- Agent profiles (global + per-project) and how Attempts resolve them.
- Auto-start behavior when moving cards into In Progress.
- Auto-commit and auto-push automation driven by project settings.
---
## Typical workflow
1. **Create a project**
