...
- **Project settings** – Each project has settings for base branch, remote, default agent/profile, and automation flags (e.g. auto‑commit + optional auto‑push on successful Attempt completion, plus “Allow scripts to fail” for non‑blocking setup/copy automation).
