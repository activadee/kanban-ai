...
import {openEditorSchema} from './attempts.schemas'

export const openEditorHandlers = createHandlers(
    zValidator('param', z.object({id: z.string()})),
    zValidator('json', openEditorSchema),
    async (c) => {
        ...
        const editorKey = body?.editorKey ?? settings.editorCommand ?? undefined
