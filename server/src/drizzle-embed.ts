...
--> statement-breakpoint
        INSERT INTO \`__new_agent_profiles\`("id", "project_id", "agent", "name", "config_json", "created_at",
                                             "updated_at")
...
--> statement-breakpoint
        INSERT INTO \`__new_attempts\`("id", "card_id", "board_id", "agent", "status", "base_branch", "branch_name",
                                       "worktree_path", "session_id", "started_at", "ended_at", "created_at",
                                       "updated_at")
        SELECT "id",
               "card_id",
               "board_id",
...
--> statement-breakpoint
    ...
    {
        tag: "0003_tearful_chronomancer", sql: `PRAGMA foreign_keys=OFF;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO \`__new_app_settings\`("id", "theme", "language", "telemetry_enabled", "notif_toast_sounds", "notif_desktop", "editor_type", "editor_command", "git_user_name", "git_user_email", "worktrees_root", "branch_template", "gh_pr_title_template", "gh_pr_body_template", "gh_autolink_tickets", "created_at", "updated_at") SELECT "id", "theme", "language", "telemetry_enabled", "notif_toast_sounds", "notif_desktop", "editor_type", "editor_command", "git_user_name", "git_user_email", "worktrees_root", "branch_template", "gh_pr_title_template", "gh_pr_body_template", "gh_autolink_tickets", "created_at", "updated_at" FROM \`app_settings\`;--> statement-breakpoint
...
PRAGMA foreign_keys=ON;`
    ...
    {
        tag: "0004_soft_sentry", sql: `PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE \`__new_app_settings\` (
	\`id\` text PRIMARY KEY DEFAULT 'singleton' NOT NULL,
	\`theme\` text DEFAULT 'system' NOT NULL,
	\`language\` text DEFAULT 'browser' NOT NULL,
