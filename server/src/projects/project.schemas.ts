...
export const updateProjectSettingsSchema = z
    .object({
        ...
        allowScriptsToFail: z.boolean().optional(),
        allowCopyFilesToFail: z.boolean().optional(),
        allowSetupScriptToFail: z.boolean().optional(),
        allowDevScriptToFail: z.boolean().optional(),
        allowCleanupScriptToFail: z.boolean().optional(),
